...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < shapes.length; i++) {
            Shape[] realShapes = {new Quadrate("Квадрат",
                    colors[new Random().nextInt(6)], new Random().nextInt(25)),
                    new Circle("Коло", colors[new Random().nextInt(6)], new Random().nextInt(25)),
                    new Trapeze("Трапеція",
                            colors[new Random().nextInt(6)], new Random().nextInt(25),
                            new Random().nextInt(25), new Random().nextInt(25)),
